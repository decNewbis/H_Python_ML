...
if __name__ == "__main__":
    ...
    for method_ in methods:
        ...
        animation_mle.save(os.path.join(BASE_DIR + f'/method_{method_}',
                                        f'mle_regression_(anim)(linear)_smpls({nsamples_}).gif'))

        # Save plot
        plt.savefig(os.path.join(BASE_DIR + f'/method_{method_}',
                                 f"mle_regression_(linear)_smpls({nsamples_}).png"))
        ...
        # Save plot
        plt.savefig(os.path.join(BASE_DIR + f'/method_{method_}',
                                 f"loss_function_mle_(linear)_smpls({nsamples_}).png"))
        plt.close()
